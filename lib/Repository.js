...
class Repository extends Requestable {
   ...
   listPullRequests(options, cb) {
      options = options || {};
      return this._requestAllPages(`/repos/${this.__fullname}/pulls`, options, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   listPullRequestReviews(number, options, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/pulls/${number}/reviews`, options, cb);
   }

   listIssues(options, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/issues`, options, cb);
   }

   listIssueComments(issue, options, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/issues/${issue}/comments`, options, cb);
   }
   ...
   listCommits(options, cb) {
      ...
      return this._requestAllPages(`/repos/${this.__fullname}/commits`, options, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   getContributors(options, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/contributors`, options, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   getContributorStats(options, cb) {
      return this._request('GET', `/repos/${this.__fullname}/stats/contributors`, options, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   getCollaborators(options, cb) {
      return this._requestAllPages(`/repos/${this.__fullname}/collaborators`, options, cb);
   }
