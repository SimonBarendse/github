...
class Repository extends Requestable {
   ...
   listIssues(options, cb) {
      return this._request('GET', `/repos/${this.__fullname}/issues`, options, cb);
   }
   ...
   getContributors(options, cb) {
      return this._request('GET', `/repos/${this.__fullname}/contributors`, options, cb);
   }
   ...
   getCollaborators(options, cb) {
      return this._request('GET', `/repos/${this.__fullname}/collaborators`, options, cb);
   }
